...
productManager.addProduct('Mouse Wireless Logi', 'Mouse inalambrico Logitech', '7500', '/images/mouse-logi.png', 20);
productManager.addProduct('Teclado Logitech', 'Teclado Logitech ES-es USB', '12500', '/images/teclado-logi.png', 18);
productManager.addProduct('Auriculares Razr', 'Auriculares gamer pro', '15900', '/images/auri-razr.png', 20);
productManager.addProduct('Monitor EPS', 'Monitor Samsung OLED', '120500', '/images/monitor.png', 7);
productManager.addProduct('DIMM RAM', 'Memoria RAM DDR 1Gb 1333 mhz', '2500', '/images/memo.png');
productManager.addProduct('DIMM RAM', 'Memoria RAM DDR 4Gb 1333 mhz', '2500', null, null);
...
console.log('Producto #code: 100', productManager.getProductByCode(100)); // Not found
